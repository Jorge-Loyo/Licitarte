...
function filtrarLicitaciones() {
    ...
    const filtradas = licitaciones.filter(l => 
        ...
        (l.laboratorio && l.laboratorio.toLowerCase().includes(search))
    );
...
function editarProducto(id, producto) {
    ...
    document.getElementById('editItem').value = producto.item;
    ...
    document.getElementById('editLaboratorio').value = producto.laboratorio || '';
