...
function mostrarProductosAdjudicados() {
    ...
    productosPagina.forEach(p => {
        ...
        tr.appendChild(createCell(p.numero_licitacion));
        tr.appendChild(createCell(p.tipo_licitacion));
        tr.appendChild(createCell(p.cliente));
        tr.appendChild(createCell(p.marca + ' - ' + p.presentacion));
        tr.appendChild(createCell(p.cantidad));
        tr.appendChild(createCell(formatearMoneda(p.precio)));
        tr.appendChild(createCell(p.fecha));
